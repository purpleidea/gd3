...
argv = [
	#'https://github.com/purpleidea/gd3', # giturl
	#'master',
	#'make test',
]
...
omv = 'wget https://github.com/purpleidea/oh-my-vagrant/raw/master/extras/install-omv.sh && chmod u+x install-omv.sh && ./install-omv.sh && wget https://github.com/purpleidea/gd3/raw/master/misc/make-path.sh && chmod u+x make-path.sh && ./make-path.sh'
